...
for (const path of Object.keys(pageMeta)) {
  ...
  const jsonLd = JSON.stringify({ '@context': 'https://schema.org', '@graph': [
    { '@type': 'Article', headline: meta.title, description: meta.description, mainEntityOfPage: canonical, image, dateModified: '2026-08-27', author: { '@type': 'Organization', name: 'How to Fish Walkthrough' }, about: { '@type': 'VideoGame', name: 'How to Fish' } },
  ...
  const markup = renderToStaticMarkup(React.createElement(App, { initialPath: path }));
