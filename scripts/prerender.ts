...
import { achievements, homeFaqs, pageMeta } from "../src/data";
...
console.log(
  `prerendered ${Object.keys(pageMeta).length} route HTML files from the React app`,
);
