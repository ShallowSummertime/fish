...
| 6 | deploy-1 | Git/Vercel | landing owner | scoped commit is on origin/main and production updates | ⏳ | |
| 7 | e2e-1 | production HTTP/browser | checker | both routes pass desktop/mobile content, media, metadata and link checks | ⏳ | |
| 8 | review | independent review | checker | no blocking accuracy, copyright, accessibility or low-value findings | ⏳ | |
| 9 | repair-and-reverify | maker + checker | split | review repairs pass affected gates, or N/A with no diff | ⏳ | |
| 10 | finalize | rankup | landing owner | records updated, remote ancestry proven, missing-material list consolidated | ⏳ | |
