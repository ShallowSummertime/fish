...
export function MutatedWhaleHandymanGuide() {
  return <article className="article guide-article"><Crumb title="Handyman achievement"/><p className="eyebrow">FINAL BOSS ACHIEVEMENT · CHECKED AUG 31, 2026</p><h1>Mutated Whale<br/><i>Handyman Guide</i></h1><p className="standfirst">Handyman’s official condition is to defeat the final boss with bare hands. This cautious route turns the Mutated Bowhead Whale crater into a controlled punch fight: finish the Volcano chain, remove damage tools, use rock cover, and only step out for short safe windows.</p>
    <GuideImage src="/images/guides/volcano/01-volcano-arrival.png" alt="Volcano arrival area before the final How to Fish boss route" caption="Handyman starts only after the normal Volcano progression has reached the final boss chain."/>
    ...
    <GuideImage src="/images/guides/volcano/02-bowhead-to-crater.png" alt="How to Fish Bowhead Whale body being taken toward the Volcano crater" caption="Carry the regular Bowhead body to the crater to begin the mutated final stage; do not confuse this setup with the Handyman completion itself."/>
    ...
    <GuideImage src="/images/guides/volcano/03-mutated-bowhead-fight.png" alt="Mutated Bowhead Whale fight at the Volcano crater" caption="Stable rock cover creates a repeatable approach: observe the tell, let the movement pass, then take only the nearest punch window."/>
    ...
    <GuideImage src="/images/achievements/9f978a5ee40c390d66605ee42333628186ccd337.webp" alt="Handyman achievement icon from How to Fish" caption="Use the in-game achievement notification as the only completion confirmation; story progress alone is not proof of Handyman."/>
