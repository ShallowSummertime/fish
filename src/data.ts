...
export const pageMeta: Record<string, {title:string; description:string; image?:string}> = {
  ...
  '/locations': { title: 'How to Fish Game Five-Island Route & Locations Guide | How to Fish Walkthrough', description: 'Deep five-stop How to Fish Game route: every Lighthouse, Forest, Desert, Rocks and Volcano objective, boss, hand-in, marker and failure recovery.', image: '/images/guides/locations/five-location-route-hero.png' },
  ...
  '/guides/reel-of-fortune': { title: 'How to Fish Reel of Fortune & Weapon Skins Guide | How to Fish Walkthrough', description: 'Use one rare Drip creature at the Reel of Fortune, identify the random cosmetic skin, equip it with Z or C, and understand GOLD GOLD GOLD.', image: '/images/guides/reel-of-fortune/reel-machine-hero.png' },
